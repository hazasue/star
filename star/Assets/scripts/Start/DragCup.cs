	...
	public void OnTriggerExit2D(Collider2D collider)
	{
		if (Manager.IsDrag == false)
		{
			...
			if(collider.tag == "slushPos1")
			{
				...
				SlushCup1.transform.localScale = new Vector3(1.5f, 1.6f, 1f);
			}
			...
			if (collider.tag == "slushPos2")
			{
				...
				SlushCup2.transform.localScale = new Vector3(1.5f, 1.6f, 1f);
			}
			...
			if (collider.tag == "slushPos3")
			{
				...
				SlushCup3.transform.localScale = new Vector3(1.5f, 1.6f, 1f);
			}
