...
public class DragCompleteBlackRice : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
	Vector2 StartPos;
	...
	public static GameObject hChar;
	GameObject aChar;
	...
	public void OnTriggerExit2D(Collider2D collider)
	{
		if (IsDrag == false)
		{
			if (collider.gameObject == RandomCharacter.Char1)
			{
				...
				if (RandomCharacter.food1 && RandomCharacter.food1.tag == "BlackRice")
				{

					Destroy(RandomCharacter.food1);
					Manager.money += Money_manager.Yellow_basic_money;
					Manager.day_money += Money_manager.Yellow_basic_money;
					Destroy(gameObject);
				...
				else if (RandomCharacter.food12 && RandomCharacter.food12.tag == "BlackRice")
				{
				...
				else if (RandomCharacter.food13 && RandomCharacter.food13.tag == "BlackRice")
				{
					Destroy(RandomCharacter.food13);
					Manager.money += Money_manager.Yellow_basic_money;
					Manager.day_money += Money_manager.Yellow_basic_money;
					Destroy(gameObject);
					if (!RandomCharacter.food1 && !RandomCharacter.food12 && !RandomCharacter.food13)
					{
						Destroy(RandomCharacter.Feel1);
						Destroy(RandomCharacter.Char1);
						RandomCharacter.charStay1 = 0f;
				...
				if (RandomCharacter.delete1)
				{
					...
					hChar.transform.localScale = new Vector3(3.05f, 3.85f, 1f);
					Destroy(hChar, 0.5f);
					RandomCharacter.delete1 = false;
				}
				if (RandomCharacter.food1.tag != "BlackRice" && RandomCharacter.food12.tag != "BlackRice" && RandomCharacter.food13.tag != "BlackRice")
				{
					if (RandomCharacter.cf1 == "1")
					{
			...
			if (collider.gameObject == RandomCharacter.Char2)
			{
				...
				if (RandomCharacter.food2 && RandomCharacter.food2.tag == "BlackRice")
				{
				...
				else if (RandomCharacter.food22 && RandomCharacter.food22.tag == "BlackRice")
				{
				...
				else if (RandomCharacter.food23 && RandomCharacter.food23.tag == "BlackRice")
				{
				...
				if (RandomCharacter.delete2)
				{
					...
					hChar.transform.localScale = new Vector3(3.05f, 3.85f, 1f);
					Destroy(hChar, 0.5f);
					RandomCharacter.delete2 = false;
				}

				if (RandomCharacter.food2.tag != "BlackRice" && RandomCharacter.food22.tag != "BlackRice" && RandomCharacter.food23.tag != "BlackRice")
				{
					if (RandomCharacter.cf2 == "1")
					{
			...
			if (collider.gameObject == RandomCharacter.Char3)
			{
				...
				if (RandomCharacter.food3 && RandomCharacter.food3.tag == "BlackRice")
				{
				...
				else if (RandomCharacter.food32 && RandomCharacter.food32.tag == "BlackRice")
				{
				...
				else if (RandomCharacter.food33 && RandomCharacter.food33.tag == "BlackRice")
				{
				...
				if (RandomCharacter.delete3)
				{
					...
					hChar.transform.localScale = new Vector3(3.05f, 3.85f, 1f);
					Destroy(hChar, 0.5f);
					RandomCharacter.delete3 = false;
				}


				if (RandomCharacter.food3.tag != "BlackRice" && RandomCharacter.food32.tag != "BlackRice" && RandomCharacter.food33.tag != "BlackRice")
				{
					if (RandomCharacter.cf3 == "1")
					{
