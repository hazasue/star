...
public class DragCompleteBlackRiceS : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
	Vector2 StartPos;
	...
	public void OnTriggerExit2D(Collider2D collider)
	{
		if (IsDrag == false)
		{
			if (collider.gameObject == RandomCharacter.Char1)
			{
				...
				if (RandomCharacter.food1 && RandomCharacter.food1.tag == "YellowRiceS")
				{

					Destroy(RandomCharacter.food1);
					Manager.money += Money_manager.Yellow_basic_money_S;
					Manager.day_money += Money_manager.Yellow_basic_money_S;
					Destroy(gameObject);
				...
				else if (RandomCharacter.food12 && RandomCharacter.food12.tag == "YellowRiceS")
				{
				...
				else if (RandomCharacter.food13 && RandomCharacter.food13.tag == "YellowRiceS")
				{
				...
				if (RandomCharacter.food1.tag != "YellowRiceS" && RandomCharacter.food12.tag != "YellowRiceS" && RandomCharacter.food13.tag != "YellowRiceS")
				{
					if (RandomCharacter.cf1 == "1")
					{
			...
			if (collider.gameObject == RandomCharacter.Char2)
			{
				...
				if (RandomCharacter.food2 && RandomCharacter.food2.tag == "YellowRiceS")
				{
				...
				else if (RandomCharacter.food22 && RandomCharacter.food22.tag == "YellowRiceS")
				{
				...
				else if (RandomCharacter.food23 && RandomCharacter.food23.tag == "YellowRiceS")
				{
				...
				if (RandomCharacter.food2.tag != "YellowRiceS" && RandomCharacter.food22.tag != "YellowRiceS" && RandomCharacter.food23.tag != "YellowRiceS")
				{
					if (RandomCharacter.cf2 == "1")
					{
			...
			if (collider.gameObject == RandomCharacter.Char3)
			{
				...
				if (RandomCharacter.food3 && RandomCharacter.food3.tag == "YellowRiceS")
				{
				...
				else if (RandomCharacter.food32 && RandomCharacter.food32.tag == "YellowRiceS")
				{
				...
				else if (RandomCharacter.food33 && RandomCharacter.food33.tag == "YellowRiceS")
				{
				...
				if (RandomCharacter.food3.tag != "YellowRiceS" && RandomCharacter.food32.tag != "YellowRiceS" && RandomCharacter.food33.tag != "YellowRiceS")
				{
					if (RandomCharacter.cf3 == "1")
					{
