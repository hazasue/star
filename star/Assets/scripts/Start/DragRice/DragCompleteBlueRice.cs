...
public class DragCompleteBlueRice : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
	Vector2 StartPos;
	...
	public void OnTriggerExit2D(Collider2D collider)
	{
		if (IsDrag == false)
		{
			if (collider.gameObject == RandomCharacter.Char1)
			{
				...
				if (RandomCharacter.food1 && RandomCharacter.food1.tag == "BlueRice")
				{

					Destroy(RandomCharacter.food1);
					Manager.money += Money_manager.Blue_basic_money;
					Manager.day_money += Money_manager.Blue_basic_money;
					Destroy(gameObject);
				...
				else if (RandomCharacter.food12 && RandomCharacter.food12.tag == "BlueRice")
				{
				...
				else if (RandomCharacter.food13 && RandomCharacter.food13.tag == "BlueRice")
				{
				...
				if (RandomCharacter.food1.tag != "BlueRice" && RandomCharacter.food12.tag != "BlueRice" && RandomCharacter.food13.tag != "BlueRice")
				{
					if (RandomCharacter.cf1 == "1")
					{
				...
				if (collider.gameObject == RandomCharacter.Char2)
				{
					...
					if (RandomCharacter.food2 && RandomCharacter.food2.tag == "BlueRice")
					{
					...
					else if (RandomCharacter.food22 && RandomCharacter.food22.tag == "BlueRice")
					{
					...
					else if (RandomCharacter.food23 && RandomCharacter.food23.tag == "BlueRice")
					{
					...
					if (RandomCharacter.food2.tag != "BlueRice" && RandomCharacter.food22.tag != "BlueRice" && RandomCharacter.food23.tag != "BlueRice")
					{
						if (RandomCharacter.cf2 == "1")
						{
					...
					if (collider.gameObject == RandomCharacter.Char3)
					{
						...
						if (RandomCharacter.food3 && RandomCharacter.food3.tag == "BlueRice")
						{
						...
						else if (RandomCharacter.food32 && RandomCharacter.food32.tag == "BlueRice")
						{
						...
						else if (RandomCharacter.food33 && RandomCharacter.food33.tag == "BlueRice")
						{
						...
						if (RandomCharacter.food3.tag != "BlueRice" && RandomCharacter.food32.tag != "BlueRice" && RandomCharacter.food33.tag != "BlueRice")
						{
							if (RandomCharacter.cf3 == "1")
							{
