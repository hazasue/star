...
public class DragCompleteBlueRiceM : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
	Vector2 StartPos;
	bool IsDrag;
	...
	public void OnTriggerExit2D(Collider2D collider)
	{
		if (IsDrag == false)
		{
			if (collider.gameObject == RandomCharacter.Char1)
			{
				...
				if (RandomCharacter.food1 && RandomCharacter.food1.tag == "BlueRiceM")
				{

					Destroy(RandomCharacter.food1);
					Manager.money += Money_manager.Blue_basic_money_M;
					Manager.day_money += Money_manager.Blue_basic_money_M;
					Destroy(gameObject);
				...
				else if (RandomCharacter.food12 && RandomCharacter.food12.tag == "BlueRiceM")
				{
				...
				else if (RandomCharacter.food13 && RandomCharacter.food13.tag == "BlueRiceM")
				{
				...
				if (RandomCharacter.food1.tag != "BlueRiceM" && RandomCharacter.food12.tag != "BlueRiceM" && RandomCharacter.food13.tag != "BlueRiceM")
				{
					if (RandomCharacter.cf1 == "1")
					{
				...
				if (collider.gameObject == RandomCharacter.Char2)
				{
					...
					if (RandomCharacter.food2 && RandomCharacter.food2.tag == "BlueRiceM")
					{
					...
					else if (RandomCharacter.food22 && RandomCharacter.food22.tag == "BlueRiceM")
					{
					...
					else if (RandomCharacter.food23 && RandomCharacter.food23.tag == "BlueRiceM")
					{
					...
					if (RandomCharacter.food2.tag != "BlueRiceM" && RandomCharacter.food22.tag != "BlueRiceM" && RandomCharacter.food23.tag != "BlueRiceM")
					{
						if (RandomCharacter.cf2 == "1")
						{
					...
					if (collider.gameObject == RandomCharacter.Char3)
					{
						...
						if (RandomCharacter.food3 && RandomCharacter.food3.tag == "BlueRiceM")
						{
						...
						else if (RandomCharacter.food32 && RandomCharacter.food32.tag == "BlueRiceM")
						{
						...
						else if (RandomCharacter.food33 && RandomCharacter.food33.tag == "BlueRiceM")
						{
						...
						if (RandomCharacter.food3.tag != "BlueRiceM" && RandomCharacter.food32.tag != "BlueRiceM" && RandomCharacter.food33.tag != "BlueRiceM")
						{
							if (RandomCharacter.cf3 == "1")
							{
