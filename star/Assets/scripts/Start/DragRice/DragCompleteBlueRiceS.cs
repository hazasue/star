...
public class DragCompleteBlueRiceS : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
	Vector2 StartPos;
	...
	public void OnTriggerExit2D(Collider2D collider)
	{
		if (IsDrag == false)
		{
			if (collider.gameObject == RandomCharacter.Char1)
			{
				...
				if (RandomCharacter.food1 && RandomCharacter.food1.tag == "BlueRiceS")
				{

					Destroy(RandomCharacter.food1);
					Manager.money += Money_manager.Blue_basic_money_S;
					Manager.day_money += Money_manager.Blue_basic_money_S;
					Destroy(gameObject);
				...
				else if (RandomCharacter.food12 && RandomCharacter.food12.tag == "BlueRiceS")
				{
				...
				else if (RandomCharacter.food13 && RandomCharacter.food13.tag == "BlueRiceS")
				{
				...
				if (RandomCharacter.food1.tag != "BlueRiceS" && RandomCharacter.food12.tag != "BlueRiceS" && RandomCharacter.food13.tag != "BlueRiceS")
				{
					if (RandomCharacter.cf1 == "1")
					{
			...
			if (collider.gameObject == RandomCharacter.Char2)
			{
				...
				if (RandomCharacter.food2 && RandomCharacter.food2.tag == "BlueRiceS")
				{
				...
				else if (RandomCharacter.food22 && RandomCharacter.food22.tag == "BlueRiceS")
				{
				...
				else if (RandomCharacter.food23 && RandomCharacter.food23.tag == "BlueRiceS")
				{
				...
				if (RandomCharacter.food2.tag != "BlueRiceS" && RandomCharacter.food22.tag != "BlueRiceS" && RandomCharacter.food23.tag != "BlueRiceS")
				{
					if (RandomCharacter.cf2 == "1")
					{
			...
			if (collider.gameObject == RandomCharacter.Char3)
			{
				...
				if (RandomCharacter.food3 && RandomCharacter.food3.tag == "BlueRiceS")
				{
				...
				else if (RandomCharacter.food32 && RandomCharacter.food32.tag == "BlueRiceS")
				{
				...
				else if (RandomCharacter.food33 && RandomCharacter.food33.tag == "BlueRiceS")
				{
				...
				if (RandomCharacter.food3.tag != "BlueRiceS" && RandomCharacter.food32.tag != "BlueRiceS" && RandomCharacter.food33.tag != "BlueRiceS")
				{
					if (RandomCharacter.cf3 == "1")
					{
