...
public class DragCompleteRedRice : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
	Vector2 StartPos;
	...
	public void OnTriggerExit2D(Collider2D collider)
	{
		if (IsDrag == false)
		{
			if (collider.gameObject == RandomCharacter.Char1)
			{
				...
				if (RandomCharacter.food1 && RandomCharacter.food1.tag == "RedRice")
				{

					Destroy(RandomCharacter.food1);
					Manager.money += Money_manager.or_basic_money;
					Manager.day_money += Money_manager.or_basic_money;
					Destroy(gameObject);
				...
				else if (RandomCharacter.food12 && RandomCharacter.food12.tag == "RedRice")
				{
				...
				else if (RandomCharacter.food13 && RandomCharacter.food13.tag == "RedRice")
				{
				...
				if(RandomCharacter.food1.tag != "RedRice" && RandomCharacter.food12.tag != "RedRice" && RandomCharacter.food13.tag != "RedRice")
				{
					if (RandomCharacter.cf1 == "1")
					{
			...
			if (collider.gameObject == RandomCharacter.Char2)
			{
				...
				if (RandomCharacter.food2 && RandomCharacter.food2.tag == "RedRice")
				{
				...
				else if (RandomCharacter.food22 && RandomCharacter.food22.tag == "RedRice")
				{
				...
				else if (RandomCharacter.food23 && RandomCharacter.food23.tag == "RedRice")
				{
				...
				if (RandomCharacter.food2.tag != "RedRice" && RandomCharacter.food22.tag != "RedRice" && RandomCharacter.food23.tag != "RedRice")
				{
					if (RandomCharacter.cf2 == "1")
					{
			...
			if (collider.gameObject == RandomCharacter.Char3)
			{
				...
				if (RandomCharacter.food3 && RandomCharacter.food3.tag == "RedRice")
				{
				...
				else if (RandomCharacter.food32 && RandomCharacter.food32.tag == "RedRice")
				{
				...
				else if (RandomCharacter.food33 && RandomCharacter.food33.tag == "RedRice")
				{
				...
				if (RandomCharacter.food3.tag != "RedRice" && RandomCharacter.food32.tag != "RedRice" && RandomCharacter.food33.tag != "RedRice")
				{
					if (RandomCharacter.cf3 == "1")
					{
