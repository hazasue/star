...
public class DragCompleteRedRiceM : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
	...
	public void OnTriggerExit2D(Collider2D collider)
	{
		if (IsDrag == false)
		{
			if (collider.gameObject == RandomCharacter.Char1)
			{
				...
				if (RandomCharacter.food1 && RandomCharacter.food1.tag == "RedRiceM")
				{

					Destroy(RandomCharacter.food1);
					Manager.money += Money_manager.or_basic_money_M;
					Manager.day_money += Money_manager.or_basic_money_M;
					Destroy(gameObject);
				...
				else if (RandomCharacter.food12 && RandomCharacter.food12.tag == "RedRiceM")
				{
				...
				else if (RandomCharacter.food13 && RandomCharacter.food13.tag == "RedRiceM")
				{
				...
				if (RandomCharacter.food1.tag != "RedRiceM" && RandomCharacter.food12.tag != "RedRiceM" && RandomCharacter.food13.tag != "RedRiceM")
				{
					if (RandomCharacter.cf1 == "1")
					{
				...
				if (collider.gameObject == RandomCharacter.Char2)
				{
					...
					if (RandomCharacter.food2 && RandomCharacter.food2.tag == "RedRiceM")
					{
					...
					else if (RandomCharacter.food22 && RandomCharacter.food22.tag == "RedRiceM")
					{
					...
					else if (RandomCharacter.food23 && RandomCharacter.food23.tag == "RedRiceM")
					{
					...
					if (RandomCharacter.food2.tag != "RedRiceM" && RandomCharacter.food22.tag != "RedRiceM" && RandomCharacter.food23.tag != "RedRiceM")
					{
						if (RandomCharacter.cf2 == "1")
						{
					...
					if (collider.gameObject == RandomCharacter.Char3)
					{
						...
						if (RandomCharacter.food3 && RandomCharacter.food3.tag == "RedRiceM")
						{
						...
						else if (RandomCharacter.food32 && RandomCharacter.food32.tag == "RedRiceM")
						{
						...
						else if (RandomCharacter.food33 && RandomCharacter.food33.tag == "RedRiceM")
						{
						...
						if (RandomCharacter.food3.tag != "RedRiceM" && RandomCharacter.food32.tag != "RedRiceM" && RandomCharacter.food33.tag != "RedRiceM")
						{
							if (RandomCharacter.cf3 == "1")
							{
