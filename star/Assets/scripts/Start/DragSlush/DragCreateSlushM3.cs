...
public class DragCreateSlushM3 : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
	Vector2 StartPos;
	bool IsDrag;
	...
	public void OnTriggerExit2D(Collider2D collider)
	{
		if (IsDrag == false)
		{
			if (collider.gameObject == RandomCharacter.Char1)
			{
				...
				if (RandomCharacter.food1 && RandomCharacter.food1.tag == "SlushOrderM3")
				{

					Destroy(RandomCharacter.food1);
					Manager.money += Money_manager.third_slush_money_M;
					Manager.day_money += Money_manager.third_slush_money_M;
					Destroy(gameObject);
				...
				else if (RandomCharacter.food12 && RandomCharacter.food12.tag == "SlushOrderM3")
				{
				...
				else if (RandomCharacter.food13 && RandomCharacter.food13.tag == "SlushOrderM3")
				{
				...
				if (RandomCharacter.food1.tag != "SlushOrderM3" && RandomCharacter.food12.tag != "SlushOrderM3" && RandomCharacter.food13.tag != "SlushOrderM3")
				{
					if (RandomCharacter.cf1 == "1")
					{
			...
			if (collider.gameObject == RandomCharacter.Char2)
			{
				...
				if (RandomCharacter.food2 && RandomCharacter.food2.tag == "SlushOrderM3")
				{
				...
				else if (RandomCharacter.food22 && RandomCharacter.food22.tag == "SlushOrderM3")
				{
				...
				else if (RandomCharacter.food23 && RandomCharacter.food23.tag == "SlushOrderM3")
				{
				...
				if (RandomCharacter.food2.tag != "SlushOrderM3" && RandomCharacter.food22.tag != "SlushOrderM3" && RandomCharacter.food23.tag != "SlushOrderM3")
				{
					if (RandomCharacter.cf2 == "1")
					{
			...
			if (collider.gameObject == RandomCharacter.Char3)
			{
				...
				if (RandomCharacter.food3 && RandomCharacter.food3.tag == "SlushOrderM3")
				{
				...
				else if (RandomCharacter.food32 && RandomCharacter.food32.tag == "SlushOrderM3")
				{
				...
				else if (RandomCharacter.food33 && RandomCharacter.food33.tag == "SlushOrderM3")
				{
				...
				if (RandomCharacter.food3.tag != "SlushOrderM3" && RandomCharacter.food32.tag != "SlushOrderM3" && RandomCharacter.food33.tag != "SlushOrderM3")
				{
					if (RandomCharacter.cf3 == "1")
					{
